...
public class CinderscapesLootTableProvider extends LootTableProvider {
    public CinderscapesLootTableProvider(DataGenerator root) {
        super(root);
    }
    ...
    protected List<Pair<Supplier<Consumer<BiConsumer<Identifier, LootTable.Builder>>>, LootContextType>> getTables() {
        return ImmutableList.of(
                Pair.of(CinderscapesBlockLootTableProvider::new, LootContextTypes.BLOCK)
        );
    }
}
