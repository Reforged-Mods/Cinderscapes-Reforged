...
public class CinderscapesBiomes {
    ...
    public static final Biome QUARTZ_CANYON = add("quartz_canyon", QuartzCanyonBiome.create());
    public static final Biome LUMINOUS_GROVE = add("luminous_grove", LuminousGroveBiome.create(), BiomeDictionary.Type.FOREST);
    public static final Biome ASHY_SHOALS = add("ashy_shoals", AshyShoalsBiome.create(), BiomeDictionary.Type.SANDY);
    ...
    private static Biome add(String s, Biome b) {
    ...
    private static Biome add(String s, Biome b, BiomeDictionary.Type special) {
        Identifier id = Cinderscapes.id(s);
        RegistryKey<Biome> key = RegistryKey.of(Registry.BIOME_KEY, id);
