...
public class CinderscapesBiomes {
    ...
    public static void initBiomeAdd(){
        //Todo fabric change, will be fixed via nebi
    ...
    private static RegistryObject<Biome> add(String s, Biome b) {
    ...
    private static RegistryObject<Biome> add(String s, Biome b, BiomeDictionary.Type special) {
        Identifier id = Cinderscapes.id(s);
        RegistryKey<Biome> key = RegistryKey.of(Registry.BIOME_KEY, id);
